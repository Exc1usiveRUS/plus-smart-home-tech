...
public class MotionSensorAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8039525476121434028L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MotionSensorAvro\",\"namespace\":\"ru.yandex.practicum.kafka.telemetry.event\",\"fields\":[{\"name\":\"linkQuality\",\"type\":\"int\"},{\"name\":\"motion\",\"type\":\"boolean\"},{\"name\":\"voltage\",\"type\":\"int\"}]}");
   ...
   * @param linkQuality The new value for linkQuality
   * @param motion The new value for motion
   * @param voltage The new value for voltage
   */
  public MotionSensorAvro(java.lang.Integer linkQuality, java.lang.Boolean motion, java.lang.Integer voltage) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: linkQuality = (java.lang.Integer)value$; break;
  ...
  /**
   * Gets the value of the 'linkQuality' field.
   * @return The value of the 'linkQuality' field.
   */
  ...
  /**
   * Sets the value of the 'linkQuality' field.
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MotionSensorAvro>
    ...
    private Builder(ru.yandex.practicum.kafka.telemetry.event.MotionSensorAvro.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.linkQuality)) {
        this.linkQuality = data().deepCopy(fields()[0].schema(), other.linkQuality);
    ...
    /**
      * Sets the value of the 'linkQuality' field.
      * @param value The value of 'linkQuality'.
      * @return This builder.
      */
    ...
    /**
      * Checks whether the 'linkQuality' field has been set.
      * @return True if the 'linkQuality' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'linkQuality' field.
      * @return This builder.
      */
    ...
    public MotionSensorAvro build() {
      try {
        ...
        record.linkQuality = fieldSetFlags()[0] ? this.linkQuality : (java.lang.Integer) defaultValue(fields()[0]);
