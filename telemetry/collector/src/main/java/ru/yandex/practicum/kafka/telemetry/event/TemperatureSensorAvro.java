...
public class TemperatureSensorAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5077017116297406313L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TemperatureSensorAvro\",\"namespace\":\"ru.yandex.practicum.kafka.telemetry.event\",\"fields\":[{\"name\":\"temperatureC\",\"type\":\"int\"},{\"name\":\"temperatureF\",\"type\":\"int\"}]}");
   ...
   * @param temperatureF The new value for temperatureF
   */
  public TemperatureSensorAvro(java.lang.Integer temperatureC, java.lang.Integer temperatureF) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: temperatureF = (java.lang.Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  /**
   * Gets the value of the 'temperatureF' field.
   * @return The value of the 'temperatureF' field.
   */
  ...
  /**
   * Sets the value of the 'temperatureF' field.
   * @param value the value to set.
   */
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TemperatureSensorAvro>
    ...
    private Builder(ru.yandex.practicum.kafka.telemetry.event.TemperatureSensorAvro.Builder other) {
      ...
      if (isValidValue(fields()[1], other.temperatureF)) {
        this.temperatureF = data().deepCopy(fields()[1].schema(), other.temperatureF);
    ...
    /**
      * Sets the value of the 'temperatureF' field.
      * @param value The value of 'temperatureF'.
      * @return This builder.
      */
    ...
    /**
      * Checks whether the 'temperatureF' field has been set.
      * @return True if the 'temperatureF' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'temperatureF' field.
      * @return This builder.
      */
    ...
    public TemperatureSensorAvro build() {
      try {
        ...
        record.temperatureF = fieldSetFlags()[1] ? this.temperatureF : (java.lang.Integer) defaultValue(fields()[1]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    out.writeInt(this.temperatureF);
